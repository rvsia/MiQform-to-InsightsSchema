...
const needFieldInformation = ["name", "label", ["label", "title"], ["data_type", "dataType"],
    ["required", "isRequired"],  ["visible", "isVisible"], ["read_only", "isReadOnly"], ["description", "helperText"]];
        ...
        tab['dialog_groups'].forEach((group) => {
            ...
            group['dialog_fields'].forEach((field) => {
                ...
                if(field["default_value"]) {
                    if(object1["component"] === "checkbox-field"){
...
console.log(JSON.stringify(parseJson(INPUT, needFieldInformation, componentMap)["schema"]));
console.log("---------------");
console.log(JSON.stringify(parseJson(INPUT, needFieldInformation, componentMap)["defaultValues"]));
